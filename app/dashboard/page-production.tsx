...
import TradeModal from '@/components/TradeModalProduction';
import { getTrendingTokens } from '@/lib/realApi';
import { Search } from 'lucide-react';

export default function Dashboard() {
  const router = useRouter();
  const { isConnected, trendingTokens, setTrendingTokens, setIsLoadingTrending, isLoadingTrending } = useStore();
  ...
  useEffect(() => {
    ...
    const loadTokens = async () => {
      ...
      try {
        const tokens = await getTrendingTokens(20, 'solana');
  ...
  }, [isConnected, router, setTrendingTokens, setIsLoadingTrending]);
        ...
        <div className="flex-1 overflow-auto scrollbar-hide">
          <div className="p-8 max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-400 mb-6">Real-time market data from DexScreener</p>
